...
#HW 8
#Discussion of Entity Resolution

Over the course of the past couple of weeks, we have done a lot of work regarding the problem of Entity Resolution, especially during the time we were connecting grantees and authors from different data sources. I would define Entity Resolution as connecting entities together that we believe represent the same person or object, and finding ways to connect these entities together that may not have the exact same data in all of the features. Going back to the example of entity resolution regarding grantees and authors, we attempted to connect grantees and authors together to better understand their relationship and connect the two together that we believed were the same person.
